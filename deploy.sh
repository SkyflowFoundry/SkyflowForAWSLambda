...
echo -e "    -H 'X-Operation: tokenize' \\\\"
echo -e "    -d '{\"cluster_id\":\"your-cluster-id\",\"vault_id\":\"your-vault-id\",\"table\":\"users\",\"records\":[{\"email\":\"test@example.com\"}]}'"
echo ""
echo -e "${GREEN}2. Tokenize (multi-column):${NC}"
echo -e "  curl -X POST ${API_URL} \\\\"
echo -e "    -H 'Content-Type: application/json' \\\\"
echo -e "    -H 'X-Operation: tokenize' \\\\"
echo -e "    -d '{\"cluster_id\":\"your-cluster-id\",\"vault_id\":\"your-vault-id\",\"table\":\"users\",\"records\":[{\"email\":\"test@example.com\",\"name\":\"John Doe\"}]}'"
echo ""
echo -e "${GREEN}3. Detokenize (governance-controlled):${NC}"
echo -e "  curl -X POST ${API_URL} \\\\"
echo -e "    -H 'Content-Type: application/json' \\\\"
echo -e "    -H 'X-Operation: detokenize' \\\\"
echo -e "    -d '{\"cluster_id\":\"your-cluster-id\",\"vault_id\":\"your-vault-id\",\"tokens\":[\"tok_abc123xyz\"]}'"
echo ""
echo -e "${GREEN}4. Detokenize (with explicit redaction):${NC}"
echo -e "  curl -X POST ${API_URL} \\\\"
echo -e "    -H 'Content-Type: application/json' \\\\"
echo -e "    -H 'X-Operation: detokenize' \\\\"
echo -e "    -d '{\"cluster_id\":\"your-cluster-id\",\"vault_id\":\"your-vault-id\",\"tokens\":[\"tok_abc123xyz\"],\"options\":{\"redactionType\":\"MASKED\"}}'"
echo ""
echo -e "${GREEN}5. Query:${NC}"
echo -e "  curl -X POST ${API_URL} \\\\"
echo -e "    -H 'Content-Type: application/json' \\\\"
echo -e "    -H 'X-Operation: query' \\\\"
echo -e "    -d '{\"cluster_id\":\"your-cluster-id\",\"vault_id\":\"your-vault-id\",\"query\":\"SELECT * FROM users LIMIT 10\"}'"
echo ""
