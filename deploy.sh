...
echo ""
echo -e "${GREEN}7. Tokenize with Context (for audit trails & governance):${NC}"
echo -e "  curl -X POST ${API_URL} \\\\"
echo -e "    -H 'Content-Type: application/json' \\\\"
echo -e "    -H 'X-Skyflow-Operation: tokenize' \\\\"
echo -e "    -H 'X-Skyflow-Cluster-ID: your-cluster-id' \\\\"
echo -e "    -H 'X-Skyflow-Vault-ID: your-vault-id' \\\\"
echo -e "    -H 'X-Skyflow-Table: users' \\\\"
echo -e "    -H 'X-Skyflow-Context-User: john@example.com' \\\\"
echo -e "    -H 'X-Skyflow-Context-Role: admin' \\\\"
echo -e "    -H 'X-Skyflow-Context-IpAddress: 1.2.3.4' \\\\"
echo -e "    -d '{\"records\":[{\"email\":\"test@example.com\"}]}'"
echo ""
echo -e "${YELLOW}Note: Context attributes flow through to Skyflow audit logs (JWT auth only)${NC}"
echo ""
echo -e "${BLUE}============================================================================${NC}"
echo -e "${BLUE}Snowflake External Function Examples${NC}"
echo -e "${BLUE}============================================================================${NC}"
echo ""
echo -e "${GREEN}8. Snowflake Tokenize (emulates Snowflake request with sf-custom- prefix):${NC}"
...
echo ""
echo -e "${GREEN}9. Snowflake Detokenize (emulates Snowflake request with sf-custom- prefix):${NC}"
echo -e "  curl -X POST ${SF_API_URL} \\\\"
echo -e "    -H 'Content-Type: application/json' \\\\"
...
echo ""
echo -e "${GREEN}10. Snowflake with Context (for audit trails):${NC}"
echo -e "  curl -X POST ${SF_API_URL} \\\\"
echo -e "    -H 'Content-Type: application/json' \\\\"
echo -e "    -H 'sf-custom-X-Skyflow-Operation: tokenize' \\\\"
echo -e "    -H 'sf-custom-X-Skyflow-Cluster-ID: your-cluster-id' \\\\"
...
echo -e "    -H 'sf-custom-X-Skyflow-Table: users' \\\\"
echo -e "    -H 'sf-custom-X-Skyflow-Column-Name: email' \\\\"
echo -e "    -H 'sf-custom-X-Skyflow-Context-User: snowflake-user' \\\\"
echo -e "    -H 'sf-custom-X-Skyflow-Context-Role: analyst' \\\\"
echo -e "    -d '{\"data\":[[0,\"john@example.com\"],[1,\"jane@example.com\"]]}'"
echo ""
